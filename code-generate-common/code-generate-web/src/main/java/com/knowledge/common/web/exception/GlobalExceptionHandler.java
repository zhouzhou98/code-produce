...
public class GlobalExceptionHandler {
    ...
    public <T> Result<T> processException(BindException e) {
        ...
        return Result.failed(ResultCodeEnum.PARAM_ERROR, msg);
    }
    ...
    public <T> Result<T> processException(NoHandlerFoundException e) {
        ...
        return Result.failed(ResultCodeEnum.RESOURCE_NOT_FOUND);
    }
    ...
    public <T> Result<T> processException(MissingServletRequestParameterException e) {
        log.error(e.getMessage(), e);
        return Result.failed(ResultCodeEnum.PARAM_IS_NULL);
    }
    ...
    public <T> Result<T> processException(MethodArgumentTypeMismatchException e) {
        log.error(e.getMessage(), e);
        return Result.failed(ResultCodeEnum.PARAM_ERROR, "类型错误");
    }
